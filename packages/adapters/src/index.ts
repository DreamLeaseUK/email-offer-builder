...
export { findBrochure, FINDER_VERSION, docType, publicDocType, editionDate, labelledLinks, isOfficialHost, ukMarker, ukPathOnOfficial, isJunkHost, looksLikePdfUrl, modelVariants, modelMatcher } from './brochure/finder.js';
