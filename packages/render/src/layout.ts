 ...
 * reference fixes (hero 550×413, stack 218×164, headshot 56×56; the reference's grid2 262×197 and grid3
 * 166×125 cards were deleted on 22 Sept 2026). Everything else derives from EMAIL_WIDTH so the arithmetic
 * stays visible.
 */
