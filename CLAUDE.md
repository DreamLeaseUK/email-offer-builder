...
**The authoritative technical map is `docs/architecture.md` (Solution Design & System Architecture, current-state).** Current state, decisions and open issues live in `docs/status-2026-09-21.md` (`-09-18.md` / `-09-16.md` / `-09-15.md` / `-09-14.md` are kept for history). **Resuming a session: `docs/PICKUP-PROMPT.md`** (rewritten end of session 3, 16 Sept — the definitive hand-off). **Brochure discovery is the finder (built 18 Sept 2026, no allowlist): the design, the decisions and the evidence are in `docs/brochure-finder-brief.md`. Since 21 Sept it has two tiers: the UK edition first, then the manufacturer's European brochure if it is in English (`market: 'eu'`, titled "European edition") — rules and evidence in `docs/status-2026-09-21.md` §3–§4.**
