...
describe('brochures', () => {
  ...
  it('offers a European edition without attaching it, and fetches and stores it only when the salesperson accepts', async () => {
    ...
    // the salesperson presses "Use the European edition": only now is the file fetched and stored
    ...
    // it is now the stored copy for the model (the interface shows it unticked to the next salesperson)
  ...
  it('lets the salesperson accept an official page from the stored search, and drops a linked brochure once its page is gone', async () => {
